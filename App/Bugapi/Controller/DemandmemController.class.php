...
##--------------------------------------------------------##
*/
class DemandmemController extends BaseController {
	/**
	 * sql script:
	 * create table hr_demand_mem(id int primary key auto_increment,
	 ...
	 * */
	 ...
	 protected $_module_name = 'demand_mem';
	 protected $id;
	 protected $demand_id;
         ...
         */
         {
            ...
            $data['position_id']   = htmlspecialchars(trim($data['position_id']));
