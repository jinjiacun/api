...
$rights2check = array('testplan_execute','testplan_create_build','testplan_metrics','testplan_planning',
                      ...
                      'testplan_add_remove_platforms', 'platform_management');
...
//add by zhouzhaoxin 20161116 for hide platform and assign link first
//when will open, only need to change config file
$gui->showplatform = config_get('mainpage_show_platform');
...
function getGrants($dbHandler,$user,$forceToNo=false)
{
  ...
  // value: string present on rights table//屏蔽平台管理
