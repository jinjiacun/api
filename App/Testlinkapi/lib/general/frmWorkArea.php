...
$aa_tfp = array( 
     ...
     'tc_exec_assignment_ex' => 'lib/plan/planTCNavigatorEx.php?feature=tc_exec_assignment',
     'executeTest'        => array('lib/execute/execNavigator.php?setting_testplan=', 
     ...
     'batch_assigned_kword' => 'lib/results/planAssignedKword.php?feature=batch_assigned_kword',

     //'checkCaseExecution' => array('lib/execute/execNavigator.php?setting_testplan=',
                              //     'lib/execute/execCheck.php?id'),
);
