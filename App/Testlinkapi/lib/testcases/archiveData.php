...
function initializeEnv($dbHandler)
{
  ...
  $gui->complexity=array('1'=>lang_get('very_simple'),'2'=>lang_get('little_simple'),'3'=>lang_get('general'),'4'=>lang_get('complex'),'5'=>lang_get('very_complex'));
  $gui->reviewed_status=array('1'=>lang_get('wait_review'),'2'=>lang_get('reviewed_passed'),'3'=>lang_get('reviewed_not_pass'));
  $testproject_id=$args->tproject_id;
  $gui->reviewer_name = null;
