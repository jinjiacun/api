...
$gui = initializeGui($db,$args,$cfg,$tcase_mgr,$commandMgr);
...
function init_args(&$cfgObj,$otName,&$tcaseMgr)
{
  ...
  $args->tc_id = isset($_REQUEST['tc_id']) ? $_REQUEST['tc_id'] : null;
  $args->complexity = isset($_REQUEST['complexity']) ? $_REQUEST['complexity'] : null;
  $args->bpm_id = isset($_REQUEST['bpm_id']) ? $_REQUEST['bpm_id'] : null;
  $args->reviewed_status = isset($_REQUEST['reviewed_status']) ? $_REQUEST['reviewed_status'] : null;
  $args->reviewer_id = isset($_REQUEST['reviewer_id']) ? $_REQUEST['reviewer_id'] : null;
  $args->author_id = isset($_REQUEST['author_id']) ? $_REQUEST['author_id'] : null;
  $args->creation_ts = isset($_REQUEST['creation_ts']) ? $_REQUEST['creation_ts'] : null;
 ...
 *
 */
function initializeGui(&$dbHandler,&$argsObj,$cfgObj,&$tcaseMgr,$commandMgr)
{
  $guiObj = new stdClass();
  ...
  $guiObj->reviewer_id = get_select_tcproject_user_id($argsObj->tproject_id, $dbHandler);
...
function renderGui(&$argsObj,$guiObj,$opObj,$templateCfg,$cfgObj,$editorKeys)
{
    ...
    $actionOperation = array('create' => 'doCreate', 'doCreate' => 'doCreate',
                             ...
                             'setExecutionType' => '', "setEstimatedExecDuration" => '', "settc_id" => '',
                             "setComplexity" => '',"setBpm_id" => '',"setReviewed_status" => '',"setReviewer_id"=> '',"setAllFields"=> '',
                             'doAddRelation' => '', 'doDeleteRelation' => '', 'removeKeyword' => '');
