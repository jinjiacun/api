...
$options = array('toc' => 0, 'req_spec_scope' => 1, 'req_business_rules'=> 1,'req_add_remaks'=> 1,
                 'req_add_definitions'=> 1,'req_testplans_id'=> 1,'req_tpname'=> 1,
                 'req_spec_author' => 1,'req_spec_type' =>1,
...
if( !is_null($childrenReq) && $req_cfg->show_child_reqs_on_reqspec_print_view)
{
	...
	$reqPrintOpts = array('toc' => 0, 'req_linked_tcs' => 1, 'req_cf' => 1,
                 		  'req_scope' => 1, 'req_business_rules'=> 1,'req_add_remaks'=> 1,
                          'req_add_definitions'=> 1,'req_testplans_id'=> 1,'req_tpname'=> 1,
	                      'req_relations' => 1, 'req_coverage' => 1,
