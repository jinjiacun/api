...
class database 
{
  ...
  // global table array 20161026 zhouzhaoxin add for app improvement
  private $global_tables_array = array(
      'assignment_status' => 'assignment_status',
      'assignment_types' => 'assignment_types',
      'attachments' => 'attachments',
      'cfield_testprojects' => 'cfield_testprojects',
      'custom_fields' => 'custom_fields',
      'db_version' => 'db_version',
      'events' => 'events',
      'inf_dynamic_list' => 'inf_dynamic_list',
      'inf_emp_info' => 'inf_emp_info',
      'inf_emp_mapping' => 'inf_emp_mapping',
      'inf_project_info' => 'inf_project_info',
      'inside_groups' => 'inside_groups',
      'inventory' => 'inventory',
      'issuetrackers' => 'issuetrackers',
      'node_types' => 'node_types',
      'keywords' => 'keywords',
      'reqmgrsystems' => 'reqmgrsystems',
      'rights' => 'rights',
      'role_rights' => 'role_rights',
      'roles' => 'roles',
      'system_mapping' => 'system_mapping',
      'testproject_issuetracker' => 'testproject_issuetracker',
      'testproject_reqmgrsystem' => 'testproject_reqmgrsystem',
  ...
  /**
   * get table name by current project
   * @param : $table_name => database table name
   * @return: project database or global database + table name
   * @author: zhouzhaoxin
   * @version: 20161026 zhouzhaoxin add for app improvement
   */
  function get_table($table_name)
  {
      if (array_key_exists($table_name, $this->global_tables_array))
      {
          // globale table
          return 'testlink.' . $table_name;
      }
      else {
          // project schema table
          return TL_SCHEMA_HEAD . $_SESSION['testprojectID'] . '.' . $table_name;
      }
  }
  
  /**
   * get schema name by project id
   * @param : $id => project id
   * @return: project schema name
   * @author: zhouzhaoxin
   * @version: 20161109 zhouzhaoxin add for app improvement
   */
  function get_schema($id)
  {
      return TL_SCHEMA_HEAD . $id;
  }
