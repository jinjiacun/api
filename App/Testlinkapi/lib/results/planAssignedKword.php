...
$control = new tlTestCaseFilterControl($db, 'plan_assignedkword_mode');
$gui = initializeGui($db, $control, $assignment_mgr);
$control->build_tree_menu($gui);
$control->formAction = $_SESSION['basehref'] . "lib/results/planAssignedKword.php";
...
function initializeGui(&$dbHandler, &$control, &$assignmentMgr) 
{
  ...
  switch($control->args->feature) 
  {
    ...
    case 'batch_assigned_kword':
      $gui->title_navigator = lang_get('navigator_batch_excec_kword');
      $gui->menuUrl = "lib/plan/batch_assigned_kword.php";
